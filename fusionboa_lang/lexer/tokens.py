...
KEYWORDS = {
    ...
    "key value pair": TokenType.DICT_TYPE,
    ...
    # Even more type name variations
    "character": TokenType.STRING_TYPE,
    "chars": TokenType.STRING_TYPE,
    "word": TokenType.STRING_TYPE,
    "sentence": TokenType.STRING_TYPE,
    "paragraph": TokenType.STRING_TYPE,
    "bits": TokenType.INTEGER_TYPE,
    "bytes": TokenType.STRING_TYPE,
    "symbol": TokenType.STRING_TYPE,
    "element": TokenType.LIST_TYPE,
    "elements": TokenType.LIST_TYPE,
    "entries": TokenType.LIST_TYPE,
    "pairs": TokenType.DICT_TYPE,
    "keyed list": TokenType.DICT_TYPE,
    ...
    "vector": TokenType.LIST_TYPE,
    "tuple": TokenType.LIST_TYPE,
