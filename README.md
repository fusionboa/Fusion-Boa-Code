...
<p align="center">
  ...
  <a href="https://github.com/fusionboa/Fusion-Boa-Code/releases">
    <img src="https://img.shields.io/badge/version-v1.0.0-purple" alt="Version">
  </a>
</p>
...
fusionboa version              # → FusionBoa Language v1.0.0
```
...
| Natural language patterns | 90+ features across 50+ syntax sections |
...
├── README.md             # This file
├── COMPLETE_SYNTAX.md    # Full v1.0.0 syntax reference (50+ sections, 90+ features)
├── fusionboa_lang/
