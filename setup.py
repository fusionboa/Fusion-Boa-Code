...
setup(
    ...
    description="FusionBoa v1.0.0 — 902 English-like keywords. Write once, compile to Python, JavaScript, Go, Rust, C++, and 18 more targets. 90+ features: multiple dispatch, generators, UFCS, macros, operator overloading, channels, memory tracking, meta-factories.",
